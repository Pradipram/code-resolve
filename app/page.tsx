...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center p-8 dark:bg-gray-900">
      <div className="flex flex-col items-center max-w-2xl w-full">
        <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-4 text-center whitespace-nowrap">
          Welcome to{" "}
          <span className="text-blue-600 dark:text-blue-400">Code-Resolve</span>
        </h1>
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 text-center">
          Save your code for revision, practice DSA and competitive programming
          problems, and level up your coding skills.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mb-10">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 flex flex-col items-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center text-sm">
              Solve curated Data Structures & Algorithms problems and track your
              progress.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 flex flex-col items-center">
